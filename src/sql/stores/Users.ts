 ...
 * service. Which of its columns is a boolean — the one thing PostgreSQL and
 * SQLite genuinely disagree about — is read off the field's encoded schema
 * rather than off its name.
 *
